<?php
   ...
   define('ADMIN_PASS', 'd41d8cd98f00b204e9800998ecf8427e');

   $session_timeout = 600;

   $mysql_server = 'dpg-cl6laiq073pc73aj2j3g-a';

   $mysql_username = 'root';

   $mysql_password = 'lWQzWB97ME4qfJ3KSHG3xfhnpfLohXCr';

   $mysql_database = 'mi_bd_dlcy';
...
<?php
...

   {
      ...
      echo "<h2>Area del Administrador</h2>\n";
...

   {
...

      {
...

         {
            ...
            echo "<select class=\"form-control\" name=\"active\" size=\"1\"><option " . ($active_value == "0" ? "selected " : "") . "value=\"0\">inactivo</option><option " . ($active_value != "0" ? "selected " : "") . "value=\"1\">activo</option></select>\n";

            echo "<input class=\"btn\" type=\"submit\" name=\"cmdSubmit\" value=\"Guardar\">";

            echo "&nbsp;&nbsp;";

            echo "<input class=\"btn\" name=\"cmdBack\" type=\"button\" value=\"Cancelar\" onclick=\"location.href='" . basename(__FILE__) . "'\">\n";
...

      {
         ...
         echo "<div id=\"header\"><a class=\"btn\" href=\"" . basename(__FILE__) . "?action=new\">Nuevo Usuario</a>&nbsp;&nbsp;<a class=\"btn\" href=\"" . basename(__FILE__) . "?action=logout\">Salir</a>\n";

         echo "<div id=\"filter\">\n";

         echo "<label>Buscar: </label> <input class=\"form-control\" placeholder=\"\" type=\"search\">\n";

         echo "</div>\n</div>\n";

         echo "<table class=\"table table-striped table-hover\">\n";

         echo "<thead><tr><th>Nombre de Usuario</th><th>Nombre Completo</th><th>Correo</th><th>Status</th><th>Accion</th></tr></thead>\n";
...

         {
            ...
            echo "<td>" . ($data['active'] == "0" ? "inactivo" : "activo") . "</td>\n";

            echo "<td>\n";

            echo "   <a href=\"" . basename(__FILE__) . "?action=edit&id=" . $data['username'] . "\" title=\"Edit\"><i class=\"icon-edit\"></i></a>&nbsp;\n";

            echo "   <a href=\"" . basename(__FILE__) . "?action=delete&id=" . $data['username'] . "\" title=\"Borrar\" onclick=\"return confirm('Estas seguro ?')\"><i class=\"icon-delete\"></i></a>\n";
